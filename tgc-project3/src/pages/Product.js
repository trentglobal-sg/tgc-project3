                                ...
                                <div className='mt-3'>
                                    ...
                                    <div className='d-flex'>
                                        <div>
                                            ...
                                            <input type="number" style={{ width: '40px', textAlign:'right' }} className='form-input form-input-sm ms-2 me-2' value={selectedQuantity} onChange={(e) => { setSelectedQuantity(e.target.value) }} disabled />
